module SpreeNewsletterSubscription
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        inject_into_file 'vendor/assets/stylesheets/spree/frontend/all.css.scss', " *= require spree/frontend/spree_newsletter_subscription\n", :before => /\*\//, :verbose => true
        inject_into_file 'vendor/assets/stylesheets/spree/backend/all.css.scss', " *= require spree/backend/spree_newsletter_subscription\n", :before => /\*\//, :verbose => true
      end
